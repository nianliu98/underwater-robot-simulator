...
function simulatorIK( t, eta, d, DC, plotData, IK )
...
for i = 1:numel(t)-9
    ...
    hold on;
    plot(IK.eeXY(1), IK.eeXY(2), 'or') % plot end effector desired location
    link1 = plot(IK.linkA(i, [1 2]), IK.linkA(i, [3 4]), 'k-');
    link2 = plot(IK.linkA(i, [5 6]), IK.linkA(i, [7 8]), 'k-');
    link3 = plot(IK.linkB(i, [1 2]), IK.linkB(i, [3 4]), 'r-');
    link4 = plot(IK.linkB(i, [5 6]), IK.linkB(i, [7 8]), 'r-');
